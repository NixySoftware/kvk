...
pub trait Api {
    fn zoeken_api(&self) -> &dyn zoeken_api::ZoekenApi;
}

pub struct ApiClient {
    zoeken_api: Box<dyn zoeken_api::ZoekenApi>,
}

impl ApiClient {
    pub fn new(configuration: Arc<configuration::Configuration>) -> Self {
        Self {
            zoeken_api: Box::new(zoeken_api::ZoekenApiClient::new(configuration.clone())),
        }
    }
}
